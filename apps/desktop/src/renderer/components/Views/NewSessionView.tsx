...
export function NewSessionView({ workspace }: { workspace: Workspace }) {
  ...
  return <div className="new-session-view">
    <div className="new-session-content">
      ...
      {(error || !selectedScope || !selectedHarness) && <div className="conversation-error" role="alert"><AlertCircle size={16} /><span>{error || (!selectedScope ? 'Add a scope to this workspace to start a conversation.' : 'Enable an agent in Settings to start a conversation.')}</span></div>}
